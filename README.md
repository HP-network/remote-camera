...
Windows x64 用户可以直接下载 [remote-camera.exe](https://github.com/HP-network/remote-camera/releases/download/v0.6.6/remote-camera.exe)，校验文件为 [remote-camera-windows-x64.sha256](https://github.com/HP-network/remote-camera/releases/download/v0.6.6/remote-camera-windows-x64.sha256)。
...
Download the Windows x64 executable from the [v0.6.6 release](https://github.com/HP-network/remote-camera/releases/tag/v0.6.6) and verify it with the published SHA-256 file.
